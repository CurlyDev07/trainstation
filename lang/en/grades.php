...
$string['aggregateonlygraded_help'] = 'An empty grade is a grade which is missing from the points. It may be from an assignment submission which has not yet been graded or from a quiz which has not yet been attempted etc.
...
$string['aggregationposition_help'] = 'This setting determines whether the category and course total columns are displayed first or last in the points reports.';
...
$string['backupwithoutgradebook'] = 'Backup does not contain points configuration';
...
$string['coursesettingsexplanation'] = 'Course settings determine how the points appears for all participants in the course.';
$string['coursetotal'] = 'Course total';
$string['createcategory'] = 'Create category';
$string['createcategoryerror'] = 'Could not create a new category';
$string['creatinggradebooksettings'] = 'Creating points settings';
$string['csv'] = 'CSV';
...
$string['eventgradeviewed'] = 'Grades were viewed in the points';
...
$string['externalurl_desc'] = 'If an external points is used, the URL should be specified here.';
...
$string['gradebook'] = 'Points';
$string['gradebookcalculationsuptodate'] = 'The calculations in the points are up to date. You may need to reload this page to see changes.';
$string['gradebookcalculationsfixbutton'] = 'Accept grade changes and fix calculation errors';
$string['gradebookcalculationswarning'] = 'Note: Some errors have been detected in calculating the grades displayed in the points. If your course has not started or is in progress, it is recommended that the errors are fixed by clicking the button below, though this will result in some grades being changed. If your course has already ended and grades have been submitted, you probably do not want to fix this issue.

The newer version is {$a->currentversion}; you are using points version {$a->gradebookversion}. You can see a list of changes in <a href="{$a->url}">Points calculation changes</a>.';
$string['gradebookhiddenerror'] = 'The points is currently set to hide everything from students.';
$string['gradebookhistories'] = 'Grade histories';
$string['gradebooksetup'] = 'Points setup';
...
$string['gradecategoryonmodform_help'] = 'This setting controls the category in which this activity\'s grades are placed in the points.';
...
* Letter - Letters or words are used to represent a range of grades, as defined in \'Letters\' in the points setup
...
$string['gradeitemislocked'] = 'This activity is locked in the points. Changes that are made to grades in this activity will not be copied to the points until it is unlocked.';
...
$string['gradepass_help'] = 'This setting determines the minimum grade required to pass. The value is used in activity and course completion, and in the points, where pass grades are highlighted in green and fail grades in red.';
...
$string['includescalesinaggregation_help'] = 'You can change whether scales are to be included as numbers in all aggregated grades across all points in all courses. CAUTION: changing this setting will force all aggregated grades to be recalculated.';
...
$string['minmaxtouse_desc'] = 'This setting determines whether to use the initial minimum and maximum grades from when the grade was given, or the minimum and maximum grades as specified in the settings for the grade item, when calculating the grade displayed in the points. It is recommended that this setting is modified at an off-peak time, as all grades will be recalculated, which may result in a high server load.';
$string['minmaxtouse_help'] = 'This setting determines whether to use the initial minimum and maximum grades from when the grade was given, or the minimum and maximum grades as specified in the settings for the grade item, when calculating the grade displayed in the points.';
$string['minmaxtouse_link'] = 'Grades_min_max';
$string['minmaxupgradedgrades'] = 'Note: Some grades have been changed in order to resolve an inconsistency in the points caused by a change in the minimum and maximum grades used when calculating the grade displayed. It is recommended that the changes are reviewed and accepted.';
$string['minmaxupgradefixbutton'] = 'Resolve inconsistencies';
$string['minmaxupgradewarning'] = 'Note: An inconsistency has been detected with some grades due to a change in the minimum and maximum grades used when calculating the grade displayed in the points. It is recommended that the inconsistency is resolved by clicking the button below, though this will result in some grades being changed.';
...
$string['modgraderescalegrades_help'] = 'When changing the maximum grades on a points item you need to specify whether or not this will cause existing percentage grades to change as well.
...
$string['modgradecategoryrescalegrades_help'] = 'When changing the maximum grades on a points item you need to specify whether or not this will cause existing percentage grades to change as well.
...
$string['mygrades_desc'] = 'This setting allows for the option of linking to an external points from the user menu.';
...
$string['outcome_help'] = 'This setting determines the outcome which this grade item will represent in the points.';
...
$string['privacy:metadata:filepurpose'] = 'Feedback files stored in the points for a user.';
...
$string['removeallcoursegrades_help'] = 'If ticked, all grade items which were manually added to the points will be deleted, together with grades and data on overridden, excluded, hidden and locked grades. Only grade items associated with activities will remain.';
$string['removeallcourseitems'] = 'Delete all items and categories';
$string['removeallcourseitems_help'] = 'If ticked, all categories and grade items which were manually added to the points will be deleted, together with grades and data on overridden, excluded, hidden and locked grades. Only grade items associated with activities will remain.';
...
$string['showonlyactiveenrol_help'] = 'This setting determines, if only active enrolled users will be visible in points report. If enabled suspended users will not be shown in points.';
...
$string['sumofgradesupgradedgrades'] = 'Note: The aggregation method "Sum of grades" has been changed to "Natural" as part of a site upgrade. Since "Sum of grades" was previously used in this course, it is recommended that you review this change in the points.';
$string['aggregatesubcatsupgradedgrades'] = 'Note: The aggregation setting "Aggregate including subcategories" has been removed as part of a site upgrade. Since "Aggregate including subcategories" was previously used in this course, it is recommended that you review this change in the points.';
...
$string['unlimitedgrades_help'] = 'By default, grades are limited by the maximum and minimum values of the grade item. Enabling this setting removes this limit, and allows grades of over 100% to be entered directly in the points.';
...
$string['writinggradebookinfo'] = 'Writing points settings';
$string['xml'] = 'XML';
$string['yes'] = 'Yes';
