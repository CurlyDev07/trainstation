...
$string['configgradebookroles'] = 'This setting allows you to control who appears on the points.  Users need to have at least one of these roles in a course to be shown in the points for that course.';
$string['configgradeexport'] = 'Choose which points export formats are your primary methods for exporting grades.  Chosen plugins will then set and use a "last exported" field for every grade.  For example, this might result in exported records being identified as being "new" or "updated".  If you are not sure about this then leave everything unchecked.';
...
$string['taskgradecron'] = 'Background processing for points';
