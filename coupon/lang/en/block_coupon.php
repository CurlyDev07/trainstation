...
$string['coupon:myaddinstance'] = 'Add a new Coupon block to the My page';
...
$string['error:moodledata_not_writable'] = 'Your sitedata/coupon_logos folder is not writable. Please fix your permissions.';
...
$string['label:generate_pdfs'] = 'Generate separate PDF\'s';
...
$string['coupons_generated_codes_only'] = '<p>Your coupon code(s) have been generated.<br/>
...
$string['pdf:titlename'] = 'Coupon';
$string['pdf-meta:title'] = 'Coupon';
$string['pdf-meta:subject'] = 'Coupon';
$string['pdf-meta:keywords'] = 'Coupon';
...
$string['coupon_mail_subject'] = 'Coupon generated';
...
$string['label:defaultrole_help'] = '
This will be the default role with which users will get assigned when claiming a coupon';

$string['default-coupon-page-template-main'] = '

<div class="" style="padding: 10px 0px;">

    <div style="padding: 10px 0px 10px 20px;text-align: center;">
        <img width="393px" style="margin: 0 auto;" src="https://trainondemand.online/pluginfile.php/1/theme_space/customlogotopbar/1603795557/TSI%20ONDEMAND%20LOGO.png">
        <br>
        This coupon allows you to access the following e-learning module(s):
        <br>
        <span style="font-weight: 700;font-size: 15px;color: #252525;"> <u> {courses} ({role}) </u></span>
        <br><br>
        Use the coupon code below to add this on your learning track.
        <br><br>
        You have {accesstime} access to this module.
        <br>
        <span style="font-weight: 700;font-size: 15px;color: #fe0000;">
            {coupon_code}
        </span>
    </div>

    <div class="" style="display: flex;justify-content: space-between;padding-top: 20px;margin-top: 5px;border-top: 2px solid #252525;border-top-style: dashed;">
        <div class="" style="border: 2px solid black;padding: 4px;width: 45%;">
            <b>For New Users:</b><br>
            <small><b>1.) Sign up at https://trainondemand.online</b></small><br>
            <small><b>2.) You will receive an email with the confirmation url. Click on the url to activate your
                    account.</b></small><br>
            <small><b>3.) Enter your coupon code in the Coupon block</b></small><br>
            <small><b>4.) Enjoy the learning experience!</b></small><br>
        </div>

        <div class="" style="border: 2px solid black;padding: 4px;width: 45%;">
            <b>For Existing Users:</b><br>
            <small><b>1.) Login at https://trainondemand.online</b></small><br>
            <small><b>2.) Enter your coupon code in the Coupon block</b></small><br>
            <small><b>3.) Enjoy the learning expericience!</b></small><br>
        </div>
    </div>
</div>
...
$string['privacy:metadata:block_coupon:userid'] = 'The primary database key of the user';
...
The coupons can be downloaded from {$a->downloadlink} (requires loggin).<br />
