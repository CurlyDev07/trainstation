...
defined('MOODLE_INTERNAL') || die();
    ...
    $string['configtitle'] = 'Space (1.11.2)';
    $string['nobootswatch'] = 'None';
    $string['pluginname'] = 'Space (1.11.2)';
...
&#x3C;/li&#x3E;</code></pre>';
    ...
    $string['hintro'] = '<div class="d-block text-center"><br /><br />Space Moodle Theme<br /><small>by Rosea Themes</small><br /><div class="badge badge-info">version 1.11.2</div>';
